...
class ContaBancaria:
    ...
    def depositar(self, valor):
        ...
        try:
            ...
            print(f"Seu depósito de R$ {valor_deposito:.2f} realizado com sucesso.")
    ...
    def transferir (self, conta_destino, valor):
        ...
        try:
            ...
            if valor_transferencia <= self.saldo: #Verificar se há saldo suficiente na conta de origem
                ...
                conta_destino.depositar(valor_transferencia) # Chamar o método depositar() da conta destino para adicionar o valor.
            else:
