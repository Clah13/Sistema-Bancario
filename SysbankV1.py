...
saldo = 0.0 #Saldo inicial (o valor pode ser alterado)
opcao = 0
...
if opcao == 1:
    ...
    Uma possível melhoria seria deixar as opções rodando até que o cliente escolha sair do programa, para que ele possa
