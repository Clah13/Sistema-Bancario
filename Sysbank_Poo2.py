...
class ContaBancaria:
    ...
    def depositar(self, valor):
        ...
        try:
            ...
            if valor_deposito <= 0:
                print("\nValor de depósito inválido. Digite um número positivo.")
                return
            self.saldo += valor_deposito  # Atualiza o saldo
    ...
    def sacar(self, valor):
        """Realiza um saque na conta, verificando o saldo."""
...
if __name__ == "__main__":
    ...
    minha_conta.depositar(200)  # Deposita um valor na conta.

    minha_conta.consultar_saldo()  # Exibe o saldo atual da conta.
    minha_conta.sacar(150)  # Saca um valor da conta (se houver saldo).
